# Deep Learning & Statistical Learning Notes

My comprehensive study notes and implementations while working through foundational machine learning and deep learning resources.
...
- [x] Success Stories and Applications
- [x] Key Definitions and Terminology
...
- [x] Linear Regression
- [x] Object-Oriented Design for Implementation
...
#### Chapter 22: Appendix: Mathematics for Deep Learning
...
- [x] Introduction to Tensors
- [x] Creating Tensors
- [x] Tensor Operations
- [x] Tensor Datatypes
- [x] Tensor Attributes
- [x] Manipulating Tensors
...
#### Section 09: Milestone Project 3
- [ ] Model Preparation
- [ ] Deployment Strategy
- [ ] Creating API
...
- [ ] Re-sampling Approach to p-Values
